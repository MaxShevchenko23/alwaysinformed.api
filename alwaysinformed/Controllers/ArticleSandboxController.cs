...
namespace alwaysinformed.Controllers
{
    ...
    public class ArticleSandboxController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ArticleGetFullDto>>> GetAllArticlesSandboxAsync()
        {
        ...
        [HttpGet("get")]
        public async Task<ActionResult<ArticleGetFullDto>> GetArticleSandboxById([FromQuery] int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<IEnumerable<ArticleGetShortDto>>> ArticleSandboxPostAsync([FromBody] ArticlePostDto dto)
        {
        ...
        [HttpPut]
        public async Task<ActionResult> GetShortLastArticlesAsync([FromBody] ArticleUpdateDto dto)
        {
